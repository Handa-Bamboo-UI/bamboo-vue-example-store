<template>
    <div>
        ...
        <el-card shadow="never" class="border-0">
            ...
            <el-table :data="tableData" stripe style="width: 100%;height: 50vh;" v-loading="loading">
                ...
                <el-table-column fixed="right" label="操作" width="180">
                    <template #default="{ row }">
                        <el-button type="primary" size="small"   @click="openDataDrawer(row.id,'user')">推广人</el-button>
