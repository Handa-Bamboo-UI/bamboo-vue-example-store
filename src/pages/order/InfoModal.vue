<template>
    <el-drawer title="订单详情" v-model="dialogVisible" size="40%" style="align-items: center;max-width: 600px;min-width: 500px;">
        <el-card shadow="never" class="mb-3">
            <template #header>
                <b class="text-md">订单详情</b>
            </template>
...
.el-drawer__body .el-card__header{
