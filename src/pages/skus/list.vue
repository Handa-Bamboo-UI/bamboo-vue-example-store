<template>
  <el-card shadow="never" class="border-0">
    <!-- 新增|刷新 -->
    <ListHeader @create="handleCreate" @refresh="getData" @delete="handleDelete" layout="create,delete,refresh"/>

    <el-table  :data="tableData" @selection-change="handleSelectionChange"  stripe style="width: 100%" v-loading="loading" ref="multiTableRef">
